...
public class ValidateRequest {
    ...
    @Schema(description = "프론트 화면의 현재 가구 배치 전체 배열. 전체 가구 배열은 모든 furniture id를 포함한다는 뜻이며, type/label/width/depth/height/productId/variantId/styleTags 같은 추천 결과 메타데이터를 다시 보내는 뜻은 아닙니다. 일부 가구 id만 전달하면 FURNITURE_ARRAY_MISMATCH가 발생할 수 있습니다.")
