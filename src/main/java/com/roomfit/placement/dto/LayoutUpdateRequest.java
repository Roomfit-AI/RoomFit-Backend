...
public class LayoutUpdateRequest {
    ...
    @Schema(description = "저장할 최종 가구 배치 전체 배열. 각 item은 full furniture object가 아니라 id, position, rotation, status 중심의 update item입니다. width/depth/height/productId/styleTags 등은 백엔드 추천 결과 메타데이터이며 요청에서 다시 전달하지 않습니다.")
