...
class LayoutRecommendControllerTest {
    ...
    void recommend_returnsLayoutWithScoreSummaryAndValidationResult() throws Exception {
        ...
        mockMvc.perform(post("/api/layouts/recommend")
                ...
                .andExpect(jsonPath("$.data.scoreSummary.collisionScore", notNullValue()))
                .andExpect(jsonPath("$.data.scoreSummary.boundaryScore", notNullValue()))
                .andExpect(jsonPath("$.data.scoreSummary.doorWindowScore", notNullValue()))
                .andExpect(jsonPath("$.data.scoreSummary.pathScore", notNullValue()))
                .andExpect(jsonPath("$.data.scoreSummary.goalScore", notNullValue()))
                .andExpect(jsonPath("$.data.scoreSummary.styleScore", notNullValue()))
